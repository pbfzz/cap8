...
//     *
//     */
//    protected boolean onFocus(int x,int y, Camera.AutoFocusCallback callback) {
//        if (mCamera == null) {
//            Log.i("b", "onCameraFocus:" + x + "," +  y);
//            return false;
//        }
//
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.schedule(outstandingTask, 1000, 5000);
...
//                x=(int)event.getX();
//                y=(int)event.getY();
//                return onFocus(x,y,myAutoFocusCallback);
//            }
//        });
